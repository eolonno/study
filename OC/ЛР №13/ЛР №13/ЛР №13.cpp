// ЛР №13.cpp : Определяет точку входа для приложения.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
        {
            wsprintf(txt, TEXT("Second timer: %d."), SecondTimer);
            PAINTSTRUCT ps;
            HDC hdc = BeginPaint(hWnd, &ps);
            TextOut(hdc, FirstX, 10, TEXT("Hello Yongster"), 14);
            TextOut(hdc, 10, 30, txt, 19);
            TextOut(hdc, ThirdX, 50, TEXT("Third timer"), 14);
            EndPaint(hWnd, &ps);
            break;
        }
        break;
