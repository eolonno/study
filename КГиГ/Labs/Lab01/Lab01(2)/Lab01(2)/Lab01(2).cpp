...
// Lab01(2).cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLab012App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CLab012App::OnAppAbout)
END_MESSAGE_MAP()


// создание CLab012App

CLab012App::CLab012App()
{
	...
	SetAppID(_T("Lab01(2).AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CLab012App

CLab012App theApp;


// инициализация CLab012App

BOOL CLab012App::InitInstance()
{
...
// обработчики сообщений CLab012App
