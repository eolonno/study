...
void CMainWnd::OnCPlot3DDef()	
{
	...
	CRectD SpaceRect(-5,5,5,-5);//задаем область область прорисовки
	CRect  WinRect;
...
CMainWnd::CMainWnd()
{
	Create(NULL,"lab8",(WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX) &~(WS_THICKFRAME),rectDefault,NULL,NULL);	
}
