...
{
	CFileDialog fileDialog(TRUE,NULL,"");	//объект класса выбора файла
...
{
	CFileDialog fileDialog(FALSE,NULL,"area.bmp");	//объект класса выбора файла
	fileDialog.m_ofn.lpstrFilter = "images (.bmp)\0*.bmp\0\0";
	int result = fileDialog.DoModal();	//запустить диалоговое окно
	if (result==IDOK)	//если файл выбран
	{
...
{
	CFileDialog fileDialog(FALSE,NULL,"screen.bmp");	//объект класса выбора файла
	fileDialog.m_ofn.lpstrFilter = "images(.bmp)\0*.bmp\0\0";
	int result = fileDialog.DoModal();	//запустить диалоговое окно
	if (result==IDOK)	//если файл выбран
	{
